...
The *Inspect screen* allows your user to see the current ticket details — its [Essentials](flutter/configuration-and-data/essentials.md) and [Metadata](flutter/configuration-and-data/ticket-metadata.md) — before submitting it.
