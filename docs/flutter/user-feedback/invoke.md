...
It can be either [New ticket screen](flutter/shake-ui/new-ticket-screen.md) or [Home screen](flutter/shake-ui/home-screen.md), depending on your preferences:
...
All other data, like [Activity history](flutter/configuration-and-data/activity-history.md) or [Black box](flutter/configuration-and-data/black-box.md), is automatically included in every user’s bug report — no additional code required.
