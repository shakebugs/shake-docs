...
Silent reports will also attach files defined with the [Shake.setShakeReportData](flutter/configuration-and-data/auto-attach-files.md) method and [Automatic Screen Recording](flutter/configuration-and-data/auto-screen-recording.md) file if the feature is turned on.
