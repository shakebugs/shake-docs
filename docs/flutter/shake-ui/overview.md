...
In this case, instruct Shake to open the [New ticket screen](/flutter/shake-ui/new-ticket-screen.md):
...
There, they have a **Submit feedback** button that opens Shake's [Home screen](/flutter/shake-ui/home-screen.md):
