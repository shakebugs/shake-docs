...
Some of the components, like [Inspect](flutter/configuration-and-data/inspect.md) and [Feedback type](flutter/user-feedback/feedback-type.md) can be turned off via the Shake configuration, and some
...
Read more about manual invocations on the [Invocations](flutter/user-feedback/invoke.md/#invoke-through-code) page.
