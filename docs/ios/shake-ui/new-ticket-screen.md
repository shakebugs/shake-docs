...
Some of the components, like [Inspect](ios/configuration-and-data/inspect.md) and [Feedback type](ios/user-feedback/feedback-type.md) can be turned off via the Shake configuration, and some
...
Read more about manual invocations on the [Invocations](ios/user-feedback/invoke.md/#invoke-through-code) page.
