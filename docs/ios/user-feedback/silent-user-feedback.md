...
Silent reports will also attach files returned by the [onPrepareReportData](ios/configuration-and-data/auto-attach-files.md) closure and [Automatic Screen Recording](ios/configuration-and-data/auto-screen-recording.md) file if the feature is turned on.
