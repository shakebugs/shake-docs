...
It can be either [New ticket screen](ios/shake-ui/new-ticket-screen.md) or [Home screen](ios/shake-ui/home-screen.md), depending on your preferences:
...
All other data, like [Activity history](ios/configuration-and-data/activity-history.md) or [Black box](ios/configuration-and-data/black-box.md), is automatically included in every user’s bug report — no additional code required.
