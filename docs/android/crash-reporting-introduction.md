---
id: crash-reporting-introduction
title: Introduction
---
...
Your end users can't opt out of sending their crash report as they can with the standard feedback, however they can optionally [provide more information](/android/crash-reporting-describe-crash) and describe what happened prior to the crash.
