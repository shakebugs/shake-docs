...
* [User feedback](android/customer-feedback/introduction.md)
* [Crash reports](android/crash-reports/introduction.md)
...
* [Pause and resume](android/configuration-and-data/disable.md)
* [Ticket description](android/configuration-and-data/screenshot.md)
* [Auto screenshot](android/configuration-and-data/screenshot.md)
* [Auto screen recording](android/configuration-and-data/automatic-screen-recording.md)
* [Essential data](android/configuration-and-data/essentials.md)
* [Activity history](android/configuration-and-data/activity.md)
* [Black box](android/configuration-and-data/blackbox.md)
* [Ticket metadata](android/configuration-and-data/metadata.md)
* [Attach files](android/configuration-and-data/attachments.md)
