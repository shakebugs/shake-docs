...
Let's suppose some of your users have opted in for beta access, others haven't.
...
You could never call the `Shake.start()` method for guest guests, but what if a user switches from host to guest mode?
