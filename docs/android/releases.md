...
### 14.1
<span class="tag-button">December 2, 2020</span>&nbsp;&nbsp;
<span class="tag-button green-tag-button">Latest version</span>

**What's new**

Shake will now automatically [redact sensitive data](android/manage-sensitive-data.md) from your network requests, notifications and touch events so it never reaches Shake servers.

We have added [console logs](android/activity.md) to Shake activity history.
