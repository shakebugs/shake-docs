...
### Handling tap on the system tray notification

Tap on the notification in the system tray will open your app launcher screen by default and provide an Intent with the notification data.

In order to show appropriate Shake screen on notification tap, you'll have to handle Intent received in the launcher Activity like shown below:
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Shake.handleChatNotificationTap(intent)
        }
        // highlight-end
    }
    ...
    protected void onNewIntent(Intent intent) {
        ...
        // Handle notifications tap when app is already running.
        // highlight-start
        Shake.handleChatNotificationTap(intent)
        // highlight-end
    }
