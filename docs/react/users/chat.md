...
The user [can reply](react/shake-ui/chat-screen.md) to your message sent over the Dashboard and provide you with more details
...
Once your user is [registered](react/users/register-user.md) with Shake, the real time chat feature is enabled automatically.
