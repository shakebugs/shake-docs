...
| [User email](/android/configuration-and-data/new-ticket-screen-elements.md)                            | <span class="tag-button yellow-tag-button">Optional</span> <span class="tag-button pink-tag-button">May contain PII</span>   | User that's submitting feedback enters this data themselves. If you decide you don't want to collect this data, you can hide this field.     |
