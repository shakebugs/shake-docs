...
The *Email* field is part of the SDK [New ticket](react/shake-ui/new-ticket-screen.md). It's optional and allows your users to leave their email address with the report they're submitting.
