...
Home screen acts as a feedback center designed to elegantly interoperate with the Shake [Users](react/users/introduction.md) feature.
...
More on the manual invocations can be read in the [Invocations](react/customer-feedback/invoke.md/#invoke-through-code) page.
